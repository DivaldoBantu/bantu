...
-- AddForeignKey
ALTER TABLE "Fornecedor" ADD CONSTRAINT "Fornecedor_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "EntidadeTerceiros"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Cliente" ADD CONSTRAINT "Cliente_entidadeId_fkey" FOREIGN KEY ("entidadeId") REFERENCES "EntidadeTerceiros"("id") ON DELETE SET NULL ON UPDATE CASCADE;
